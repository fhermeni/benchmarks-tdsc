 ...
 */
public class SplitableVJobLauncher extends CustomizablePlannerModule {
    ...
    public SplitableVJobLauncher(DurationEvaluator d) {
        super(d);
    ...
    public TimedReconfigurationPlan compute(Configuration src,
        ...
        for (Partition p : parts) {
            try {
                VJobLauncher m = new VJobLauncher(getDurationEvaluator());
        ...
        try {
            return TimedReconfigurationPlans.merge(ress);
